...
eq(M.resultColumns(hangWidth(1), 1, 280, 8), 1, "1 provider at 520 gives 1")
eq(M.resultColumns(hangWidth(2), 2, 280, 8), 1, "2 providers at 520 gives 1")
eq(M.resultColumns(hangWidth(3), 3, 280, 8), 2, "3 providers at 630 gives 2")
eq(M.resultColumns(hangWidth(4), 4, 280, 8), 2, "4 providers at 840 gives 2")
eq(M.resultColumns(hangWidth(5), 5, 280, 8), 3, "5 providers at 960 gives 3")
