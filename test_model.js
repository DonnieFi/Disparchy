...
for (var providers = 1; providers <= 5; providers++) {
    var fitted = M.panelWidth(providers, 1920, 520, 280, 8, insets)
    eq(M.resultColumns(fitted - insets, providers, 280, 8), Math.min(providers, 3),
        "wide screen columns for " + providers)
}
eq(M.panelWidth(1, 1920, 520, 280, 8, insets), 520, "1 provider on a wide screen is the minimum")
eq(M.panelWidth(2, 1920, 520, 280, 8, insets), 2 * 280 + 8 + insets, "2 providers fit two columns")
eq(M.panelWidth(3, 1920, 520, 280, 8, insets), 3 * 280 + 16 + insets, "3 providers fit three columns")
eq(M.panelWidth(5, 1920, 520, 280, 8, insets), 3 * 280 + 16 + insets, "5 providers still cap at three columns")
eq(M.panelWidth(3, 700, 520, 280, 8, insets), 700, "a 700 screen caps 3 providers")
eq(M.resultColumns(M.panelWidth(3, 700, 520, 280, 8, insets) - insets, 3, 280, 8), 2,
    "3 providers on a 700 screen wrap to 2")
eq(M.panelWidth(1, 400, 520, 280, 8, insets), 400, "a 400 screen wins over the 520 minimum")
eq(M.panelWidth(3, 400, 520, 280, 8, insets), 400, "3 providers on a 400 screen stay at 400")
eq(M.panelWidth(1, 3840, 1040, 560, 16, 32), 1040, "scale 2 with 1 provider is the scaled minimum")
eq(M.panelWidth(2, 3840, 1040, 560, 16, 32), 2 * 560 + 16 + 32, "scale 2 with 2 providers")
eq(M.panelWidth(3, 3840, 1040, 560, 16, 32), 3 * 560 + 32 + 32, "scale 2 with 3 providers")
eq(M.panelWidth(3, NaN, 520, 280, 8, insets), 3 * 280 + 16 + insets, "missing screen does not cap")
eq(M.panelWidth(3, 0, 520, 280, 8, insets), 3 * 280 + 16 + insets, "non-positive screen does not cap")
eq(M.panelWidth(3, -20, 520, 280, 8, insets), 3 * 280 + 16 + insets, "negative screen does not cap")
eq(M.panelWidth(NaN, 1920, 520, 280, 8, insets), 520, "non-finite provider count falls back to one")
is(isFinite(M.panelWidth(3, 1920, NaN, 280, 8, insets)), "non-finite minimum stays finite")
is(isFinite(M.panelWidth(3, 1920, 520, NaN, 8, insets)), "non-finite column width stays finite")
is(isFinite(M.panelWidth(3, 1920, 520, 280, NaN, insets)), "non-finite gap stays finite")
is(isFinite(M.panelWidth(3, 1920, 520, 280, 8, NaN)), "non-finite insets stay finite")
